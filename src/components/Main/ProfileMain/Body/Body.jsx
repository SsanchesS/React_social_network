  ...
  <div className={s.Wrap}>
    <div className={s.body}>
      ...
      <div className={`card ${s.createPost}`}>
        ...
        <div className={s.img}><img src={""} alt="avatar" /></div>                {/*user.avatar_file*/}
    ...
    <div className={s.sidebar}>
        <div className={`card ${s.sideCard}`}>
          <a className={`${s.sideCardA} flex`} href="#"><p>Друзья</p><div className={s.count}>0</div></a>             {/* friends-user-count */}
